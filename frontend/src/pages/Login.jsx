...
export default function Login() {
  ...
  // Removed: const navigate = useNavigate(); (Not needed since we use window.location.href)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 2. (Optional) Save user data if your frontend reads it directly from storage
      localStorage.setItem("user", JSON.stringify(res.user));

      // 3. Force a full page reload to update the UI state
